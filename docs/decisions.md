...
- Partners v1: no external IDV provider; `lib/verification` stays fail-closed/quarantined.
  Partner details are reviewed administratively. Do not imply camera/document/selfie IDV.
